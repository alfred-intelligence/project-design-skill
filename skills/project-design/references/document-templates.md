...
- **Delivery model:** [artifact (library/CLI/binary) / deployment (site/service/infra)] (motivation: ...)
- **Release cadence:** [continuous via release-please / calendar / ad-hoc / deploy-as-release / apply-as-release] (motivation: ...)
