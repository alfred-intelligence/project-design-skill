...
- **DevOps routine even solo** — certain routines (commits, releases, branch protection)
  are always generated, to build muscle memory and give the implementing agent clear
